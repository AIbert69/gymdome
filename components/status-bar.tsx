export function StatusBar() {
  return (
    <div className="pointer-events-none absolute inset-x-0 top-0 z-30 flex h-[54px] items-end justify-between px-[30px] pb-2 text-white">
      <div className="text-[17px] font-semibold tracking-[-0.4px]">9:41</div>
